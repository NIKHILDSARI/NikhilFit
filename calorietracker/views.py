...
def home(request):
    ...
    return render(request,'calorietracker/main.html',context)
...
def fooditem(request):
    ...
    return render(request,'calorietracker/fooditem.html',context)
...
def createfooditem(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('/')
    context={'form':form}
    return render(request,'calorietracker/createfooditem.html',context)
...
def registerPage(request):
    ...
    context={'form':form}
    return render(request,'calorietracker/register.html',context)
...
def loginPage(request):
    ...
    return render(request,'calorietracker/login.html')
...
def userPage(request):
    ...
    return render(request,'calorietracker/user.html',context)
...
def addFooditem(request):
    ...
    context={'form':form}
    return render(request,'calorietracker/addUserFooditem.html',context)
